...
description: >
  ...
  別プラグイン Agentic Harness（Secretary editionが記録する互換基準は0.5.1）の導入状態を確認し、未導入ならhost別の正式手順を案内、導入済みなら
...
<!-- agentic-secretary:clarity-collaboration:build:v1 -->
...
- Agentic Harness 0.5.1: `https://github.com/mtaiseeei/agentic-harness`
