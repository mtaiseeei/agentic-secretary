...
`resolve --home <HOME> --edition agentic-secretary` をread-only実行し、`resolved`なら返されたcanonical workspaceへ接続する。
...
1. `registry-register --home <HOME> --workspace <workspace> --edition agentic-secretary --confirm`
