...
`0.12.0`ではpublic Agentic版のsource candidateとして収録しています。まだtag、GitHub Release、marketplace、installed cache、
...
candidate `0.12.0`では4 surfaceとも実機検証前なので、対応設計であっても`verified: false`です。
