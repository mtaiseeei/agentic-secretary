...
- Sprint 041〜050ではpush、tag、Release、marketplace公開、cache更新、実downstream反映を対象外とした。Sprint 054では、各版の最終candidateが同Sprintの必須gateをPASSした後に限り、承認済みの3版公開とこのMacへのprivate版反映を行う。
