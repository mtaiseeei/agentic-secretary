...
try {
  ...
  record("HS-003", "PASS", "semantic-current-bundle", () => {
    ...
    write(japanese, "docs/feedback/sprint-050-patch-004.md", "# 独立評価\n\n**判定:** 合格\n\n- verification-scope-issueの分類根拠: 該当なし\n");
  ...
  record("HS-005", "PASS", "bounded-current-fallbacks", () => {
    ...
    assert.equal(report.harness.sources.filter((row) => row.role === "requirements-reference" && row.coverage === "inspected").length, 6);
  });
