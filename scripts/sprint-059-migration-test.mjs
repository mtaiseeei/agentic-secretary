...
const fixtureRoot = realpathSync(mkdtempSync(join(process.env.TMPDIR || tmpdir(), "sprint059-migration-")));
...
process.stdout.write(`SPRINT059_MIGRATION_PASS=${pass} SPRINT059_MIGRATION_FAIL=${fail}\n`);
