...
try {
  await test("PK-001", "Claude manifestは0.12.0のClarity Skillを列挙し標準Hookを重複宣言しない", () => {
  ...
  await test("PK-006", "CHANGELOG／README／guideはAgentic source candidate段階を明示", () => {
    ...
    for (const phrase of ["Project Clarity", "GitHub Actions", "Secretary Voice", "LLM"]) assert.match(text(repo, "plugins/secretary/CHANGELOG.md"), new RegExp(phrase, "u"));
  });
