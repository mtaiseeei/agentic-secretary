...
| Codex App | Codex plugin / repository marketplace | [guide](adapters/codex-app/README.md) | `external-live-gate-unavailable` |
| Codex CLI | Codex plugin / repository marketplace | [guide](adapters/codex-cli/README.md) | `external-live-gate-unavailable` |
