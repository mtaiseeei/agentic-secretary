...
`0.10.1`で追加した既存workspaceのidentity migrationは変更せず、完了済みなら再実行しません。`0.13.0`向けmigrationがworkspace未変更で停止した場合は、[回復ガイド](docs/guide/update-0.13.0-migration-recovery.md)で`0.13.1`用の新しいplanを確認します。
